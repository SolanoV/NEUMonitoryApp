        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex-shrink-0 flex items-center gap-3">
            <Link href="/" className="flex items-center gap-3 hover:opacity-90 transition-opacity">
              {/* Subtle Black Glow in Light Mode, Primary Green Glow in Dark Mode */}
            ...
            {loading ? (
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="hidden sm:flex items-center gap-2 mr-2">
                  <Link 
                    href={`/${role}`}
                    className="bg-white/10 hover:bg-white/20 dark:bg-gray-800 dark:hover:bg-gray-700 border border-white/20 dark:border-gray-600 px-4 py-1.5 rounded-md text-sm font-semibold transition-colors shadow-sm"
                  >
                    Dashboard
                  </Link>
                  
                  {/* Only show the User Profiles button if the user is an Admin */}
                  {role === "admin" && (
                    <Link 
                      href="/profiles"
                      className="bg-white/10 hover:bg-white/20 dark:bg-gray-800 dark:hover:bg-gray-700 border border-white/20 dark:border-gray-600 px-4 py-1.5 rounded-md text-sm font-semibold transition-colors shadow-sm"
