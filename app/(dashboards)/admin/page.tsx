...
export default function AdminDashboard() {
  ...
  // NEW: State to hold our search and filter values
      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">Manage and monitor university MOAs.</p>
          </div>
        ...
        {/* Pass the actual VALUES to the Table so it can filter the rows */}
        <MoaTable 
